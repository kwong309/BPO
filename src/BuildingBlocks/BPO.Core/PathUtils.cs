...
namespace BPO.Core
{
    public class PathUtils
    {
        ...
        public static string GetCurrentFileNameWithoutExtension()
        {
            ...
            {
                return Path.GetFileNameWithoutExtension(HttpContext.Current.Request.Path.Value);
            }
            return string.Empty;
        }
        ...
        {
            return DirectoryUtils.IsInDirectory(Combine(WebConfigUtils.ContentRootPath, DirectoryUtils.AspnetClient.DirectoryName), path)
                   || DirectoryUtils.IsInDirectory(Combine(WebConfigUtils.ContentRootPath, DirectoryUtils.Bin.DirectoryName), path)
                   || DirectoryUtils.IsInDirectory(Combine(WebConfigUtils.ContentRootPath, DirectoryUtils.SiteFiles.DirectoryName), path)
                   || DirectoryUtils.IsInDirectory(Combine(WebConfigUtils.ContentRootPath, WebConfigUtils.AdminDirectory), path)
                   || IsEquals(Combine(WebConfigUtils.ContentRootPath, "web.config"), path)
                   || IsEquals(Combine(WebConfigUtils.ContentRootPath, "Global.asax"), path);
        }
        ...
        public static string MapPath(string virtualPath)
        {
            ...
            var rootPath = WebConfigUtils.ContentRootPath;
        ...
        {
            return Combine(WebConfigUtils.ContentRootPath, DirectoryUtils.SiteFiles.DirectoryName, DirectoryUtils.SiteFiles.TemporaryFiles, relatedPath);
        }

        public static string GetMenusPath(params string[] paths)
        {
            var directoryPath = WebConfigUtils.ContentRootPath;
        ...
        {
            return Combine(WebConfigUtils.ContentRootPath, DirectoryUtils.SiteFiles.DirectoryName, DirectoryUtils.SiteFiles.UserFiles, userName, relatedPath);
        }
        ...
        public static string PhysicalSiteServerPath => Combine(WebConfigUtils.ContentRootPath, WebConfigUtils.AdminDirectory);

        public static string PhysicalSiteFilesPath => Combine(WebConfigUtils.ContentRootPath, DirectoryUtils.SiteFiles.DirectoryName);
    }
}
