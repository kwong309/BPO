    ...
    public class PageUtils
    {
        ...
        public static string GetScheme()
        {
            ...
            if (HttpContext.Current != null)
            {
                ...
                {
                    scheme = HttpContext.Current.Request.Scheme;
                }
            }
        ...
        public static string ApplicationPath => HttpContext.Current != null ? HttpContext.Current.Request.PathBase.Value : "/";
        ...
        public static string GetIpAddress()
        {
            ...
            try
            {
                //取CDN用户真实IP的方法
                //当用户使用代理时，取到的是代理IP
                result = HttpContext.Current.Request.Headers["HTTP_X_FORWARDED_FOR"];
                ...
                if (string.IsNullOrEmpty(result))
                    result = HttpContext.Current.Request.Headers["REMOTE_ADDR"];
                //if (string.IsNullOrEmpty(result))
                //    result = HttpContext.Current.Request.Headers;
                if (string.IsNullOrEmpty(result))
                    result = "localhost";
        ...
        {
            var url = HttpContext.Current.Request.Headers["HTTP_REFERER"];
            return url;
        }
        ...
        public static string GetReturnUrl(bool toReferer)
        {
            ...
            if (!string.IsNullOrEmpty(HttpContext.Current.Request.Query["ReturnUrl"]))
            {
                redirectUrl = ParseNavigationUrl(HttpContext.Current.Request.Query["ReturnUrl"]);
            }
            else if (toReferer)
            {
        ...
        public static void Download(HttpResponse response, string filePath, string fileName)
        {
            ...
            response.Headers.Append("Content-Disposition", "attachment; filename=" + UrlEncode(fileName));
            response.Body = System.IO.File.Open(filePath, System.IO.FileMode.Open);
